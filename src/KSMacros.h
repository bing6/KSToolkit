...
/**
 * @brief 获取一个可缩放的尺寸值,前提是需要以一个设备尺寸做参照
 */
...
#define KS_NOTIFY               [NSNotificationCenter defaultCenter]
#define KS_NOTIFY_POST1(p)      [[NSNotificationCenter defaultCenter] postNotificationName:p object:nil];
#define KS_NOTIFY_POST2(p, obj) [[NSNotificationCenter defaultCenter] postNotificationName:p object:obj];
